...
int main(int argc, char **argv[])
{
     ...
     AngleAxisd t_V(M_PI / 4, Vector3d(0, 0, 1)); // 轴角、旋转向量
     ...
     // 2.使用【旋转矩阵】转【旋转向量】的方式

     // 2.1 使用旋转向量的 fromRotationMatrix() 函数来对旋转向量赋值（注意此方法为旋转向量独有,四元数没有）
     AngleAxisd V2;
     ...
     // 对四元数赋值的三大种方法（注意 Eigen 库中的四元数前三维是【虚部】, 最后一维是【实部】）
